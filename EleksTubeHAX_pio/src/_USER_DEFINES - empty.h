...
// #define HARDWARE_ELEKSTUBE_GEN2_CLOCK // uncomment for the original Elekstube clock Gen2 (ESP32 Pico D4 Chip)
...
// #define HARDWARE_NOVELLIFE_CLOCK   // uncomment for the NovelLife SE version (Gesture only) - tested and working!; Non-SE version (Buttons only) NOT tested!; Pro version (Buttons and Gesture) NOT tested!

...
#define HARDWARE_Xunfeng_CLOCK      // uncomment for the Xunfeng EleksTube Clone (ESP32-S2-WROOM module)-> Use env EleksTubeHaxXunfeng to compile! -> Backlight LED not working yet!

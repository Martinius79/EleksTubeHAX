...
char MqttCommandPattern[MAX_PATTERN_LENGTH] = {0};
bool MqttCommandPatternReceived = false;
char MqttCommandBackPattern[MAX_PATTERN_LENGTH] = {0};
...
char MqttStatusPattern[MAX_PATTERN_LENGTH] = {0};
char MqttStatusBackPattern[MAX_PATTERN_LENGTH] = {0};
...
char LastSentPattern[MAX_PATTERN_LENGTH] = {0};
char LastSentBackPattern[MAX_PATTERN_LENGTH] = {0};
...
#ifdef MQTT_USE_TLS
    espClient.setCACert(SSL_CA_PEM);
#endif
